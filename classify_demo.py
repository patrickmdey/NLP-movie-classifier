...
if __name__ == "__main__":
    ...
    checkpoint_model = "bert"

    if checkpoint_model == "bert":
        checkpoint = "distilbert-base-uncased"
        model_name = "Patrickmdey/nlp-imdb80-distilbert"
    else:
        checkpoint = "roberta-base"
        model_name = "Patrickmdey/nlp-roberta-base"
    ...
    model = AutoModelForSequenceClassification.from_pretrained(model_name, num_labels=5, pad_token_id=tokenizer.pad_token_id).to(device)
